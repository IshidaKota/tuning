...
stn = {'chiba1buoy':137,'chibaharo':47,'kawasaki':223,'urayasu':52}
...
for fname in fnames:
    ...
    # print(index) # 295
        ...
        ## print(fvcom.grid.h)
        time.plot_surface(z, fvcom.data.salinity, fill_seabed=True, h_offset=0, h_min=fvcom.grid.h,norm=Normalize(vmin=15, vmax=40))
